...
import org.sakaiproject.kaltura.util.RoleUtil;
...
public class RoleProviderService {
    ...
    public ActionReturn addRoleMapping(String data) {
        ...
        List<KalturaLtiRole> kalturaLtiRoles;
        try {
            kalturaLtiRoles = JsonUtil.parseFromJson(data, KalturaLtiRole.class);
        } catch (ClassNotFoundException e) {
            errorRole.updateErrorList(e.toString(), "add", null);
            kalturaLtiRoles = new ArrayList<>();
        }

        List<KalturaLtiRole> added = new ArrayList<>(kalturaLtiRoles.size());
    ...
    public ActionReturn updateRoleMapping(String id, String data) {
        ...
        List<KalturaLtiRole> kalturaLtiRoles = null;
        try {
            kalturaLtiRoles = JsonUtil.parseFromJson(data, KalturaLtiRole.class);
        } catch (ClassNotFoundException e) {
            errorRole.updateErrorList(e.toString(), "update", null);
            kalturaLtiRoles = new ArrayList<>();
        }
        List<KalturaLtiRole> updated = new ArrayList<>(kalturaLtiRoles.size());
