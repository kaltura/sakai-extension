...
public class KalturaEntityProducer implements EntityProducer {
    ...
    public void init() {
        ...
        try {
            ...
            if (ComponentManager.get(KalturaEntityProducer.class.getName()) != null) {
                log.error("Found "+KalturaEntityProducer.class.getName()+" in the ComponentManager");
            } else {
                log.error("FAILED to insert and lookup "+KalturaEntityProducer.class.getName()+" in the Sakai ComponentManager, archive imports for kaltura will not work");
            }
        } catch (Exception ex) {
    ...
    public String merge(String siteId, Element root, String archivePath, String fromSiteId,
        ...
        if (!willArchiveMerge()) {
            ...
            if(service!=null){
                ...
                try{
                    ...
                    System.out.println("Json string for site copy request from kaltura :" + jsonString);
                    ...
                    if(copyStatus!=null){
                        ...
                        System.out.println("resultcode on site copy request :"+ resultCode);
                        String message = copyStatus.getString("message");
                        if(message!=null){
                            System.out.println("message from site copy request :"+ message);
                        ...
                        if(jobids.size()>0 && jobids.get(0)!=-1){
                            ...
                            kalturaSiteCopyBatchDao.save(siteCopyBatch);
                            Long batchId = siteCopyBatch.getBatchId();
                            if(batchId!=null){
                                System.out.println("Batch created on sakai table:"+ batchId.toString());
                                ...
                                for(Long kalturajobid:jobids){
                                    ...
                                    kalturaSiteCopyJobDao.save(kalturajob);
                                    if(kalturajob.getJobId()!=null){
                                        System.out.println("Kaltura job created on sakai table:"+ kalturajob.getJobId().toString());
                                    }
                                }
        ...
        log.error("kaltura EP.merge result: "+result);
        return result;
    }
